...
def MT_RUN(simPa):
    ...
    return dt, MT_length_sum, MT_length_full, CATASTROPHE_TIMES, CATASTROPHE_LENGTH, barrier_contact_times, \
        EB_comet_sum, MT_cap, Cap_threshold, frame_rate_actual, EB_profiles, washout_times, catastrophe_washout, Cap_length_sum
