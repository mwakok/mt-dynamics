...
def fig_EB_cat_hist(simPa, 
    ...
    num_fig: int
        Figure number.
    EB_comet_sum: TODO
        Num of "B"s during a time window before catastophe.
    barrier_contact_times: TODO
...
def fig_washout(simPa,file_figure, num_fig, washout_times, catastrophe_washout, MT_length_sum):     
    ...
    # Relation growth speed and delay times
    # Relation cap size and delay times
    # Relation shrinkage length and growth speed
